...
block.forEach(function (el) {
  react_dom__WEBPACK_IMPORTED_MODULE_1___default().render((0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(Results, null), el);
...
function Results() {
    ...
    const getResults = async () => {
      try {
        ...
        if (!response.statusText === "OK") {
          ...
          setResult(result);
          const parsedResult = papaparse__WEBPACK_IMPORTED_MODULE_2___default().parse(result.csv_url, {
            download: true,
            header: true,
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("tr", null, tableData.length > 0 && Object.keys(tableData[0]).map((key, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("th", {
    key: index
  }, key)))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("tbody", null, tableData.map((item, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("tr", {
    key: index
