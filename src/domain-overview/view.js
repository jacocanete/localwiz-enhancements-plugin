...
const block = document.querySelectorAll(".domain-overview-update");

block.forEach(function (el) {
	ReactDOM.render(<DomainOverview />, el);
	el.classList.remove("domain-overview-update");
});
